							...
							<div class="row-fluid ">
								...
								<div class="span11 main-content-grid">
									...
									<div class="ty-mainbox-container clearfix">
										...
										<h1 class="ty-mainbox-title">Sign in</h1>
											...
											<div class="ty-login">
												<form action="abcd" method="post">
													<input type="hidden" name="flag" value="login" /> <input
														...
														value="index.php?return_url=index.php%3Fdispatch%3Dorders.search&amp;dispatch=auth.login_form" />
													<div class="ty-control-group">
														<label for="login_main_login"
															class="ty-login__filed-label ty-control-group__label cm-required cm-trim cm-email">Email</label>
														<input type="text" id="login_main_login" name="username"
															size="30" value="" class="ty-login__input cm-focus" />
													</div>

													<div class="ty-control-group ty-password-forgot">
														<label for="psw_main_login"
															...
															class="ty-password-forgot__a" tabindex="5">Forgot
															your password?</a> <input type="password" id="psw_main_login"
															name="password" size="30" value=""
													...
													<div class="buttons-container clearfix">
														<div class="ty-float-right">
															...
															<button class="ty-btn__login ty-btn__secondary ty-btn"
																type="submit" name="dispatch[auth.login]">Sign
																in</button>
														...
														<div class="ty-login__remember-me">
															<label for="remember_me_main_login"
																class="ty-login__remember-me-label"><input
																class="checkbox" type="checkbox" name="remember_me"
																id="remember_me_main_login" value="Y" />Remember me</label>
														</div>
													</div>
