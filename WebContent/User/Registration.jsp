...
<div class="tygh-content clearfix">
    ...
    <div class="ty-breadcrumbs clearfix">
        <a href="login.jsp" class="ty-breadcrumbs__a">Home</a><span class="ty-breadcrumbs__slash">></span><span class="ty-breadcrumbs__current">Registration</span>
    </div>
<!--breadcrumbs_10--></div><div class="ty-mainbox-container clearfix">
    ...
    <div class="ty-account">
        ...
        <form name="profiles_register_form" action="<%=request.getContextPath()%>/Registration" method="post">
                    <input type="hidden" name="flag" value="insert">
        
       <div class="ty-control-group">
        <label for="email" class="ty-control-group__title cm-required cm-email cm-trim">Firstname</label>
        <input type="text" id="Firstname" name="Firstname" size="32" maxlength="128" value="" class="ty-input-text cm-focus" required="required"/>
    </div>
    
            
<div class="ty-control-group">
        <label for="email" class="ty-control-group__title cm-required cm-email cm-trim">Lastname</label>
        <input type="text" id="Lastname" name="Lastname" size="32" maxlength="128" value="" class="ty-input-text cm-focus" required="required" />
    </div>
   ...
   <div class="ty-control-group">
    ...
    <div class="ty-control-group">
        ...
        <input type="password" id="Password" name="Password" size="32" maxlength="32" value="" class="ty-input-text cm-autocomplete-off" required="required" />
    </div>

    <div class="ty-control-group">
        <label for="password2" class="ty-control-group__title cm-required cm-password">Confirm password</label>
        <input type="Password" id="ConfirmPassword" name="ConfirmPassword" size="32" maxlength="32" value="" class="ty-input-text cm-autocomplete-off" required="required" />
    </div>
...
(function(_, $) {
    ...
    $.extend(_, {
        ...
        regexp: [],
        current_url: 'http://demos.templatemela.com/cscart/CST02/CST020042/profiles-add/',
