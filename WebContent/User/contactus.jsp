...
<meta name="description" content="You can send us a message using the form below " />
...
<div class="tygh-content clearfix">
    ...
    <div class="ty-breadcrumbs clearfix">
        <a href="http://demos.templatemela.com/cscart/CST02/CST020042/" class="ty-breadcrumbs__a">Home</a><span class="ty-breadcrumbs__slash">></span><span class="ty-breadcrumbs__current">Contact us</span>
    </div>
<!--breadcrumbs_10--></div><div class="ty-mainbox-container clearfix">
            ...
            <div class="ty-form-builder__description">You can send us a message using the form below.</div>
    
<div class="ty-form-builder">
    <form action="http://demos.templatemela.com/cscart/CST02/CST020042/" method="post" name="forms_form" enctype="multipart/form-data">
    ...
    <input type="hidden" name="page_id" value="30" />
            ...
            <div class="ty-control-group">
            <label for="elm_1" class="ty-control-group__title cm-required ">Full name</label>
            ...
            <div class="ty-control-group">
            <label for="elm_3" class="ty-control-group__title cm-required ">Body</label>
        ...
        <div class="captcha ty-control-group">
                    <label for="verification_answer_iv_58afd9be0578b" class="cm-required ty-captcha__label">Anti-bot validation</label>
                    <div class="cm-field-container">
                    <input class="ty-captcha__input cm-autocomplete-off" type="text" id="verification_answer_iv_58afd9be0578b" name="verification_answer" value= "" />
            <input type="hidden" name="verification_id" value= "iv_58afd9be0578b" />
                    <div class="ty-captcha__code">
                <img id="verification_image_iv_58afd9be0578b" class="ty-captcha__img" src="http://demos.templatemela.com/cscart/CST02/CST020042/index.php?dispatch=image.captcha&amp;verification_id=iv_58afd9be0578b&amp;no_session=Y&amp;iv_58afd9be0578b=" alt="" onclick="this.src += '|1' ;"  width="110" height="30" />
                <i class="ty-icon-refresh ty-captcha__refresh" onclick="document.getElementById('verification_image_iv_58afd9be0578b').src += '|1';"></i>
            </div>
...
(function(_, $) {
    ...
    $.extend(_, {
        ...
        regexp: [],
        current_url: 'http://demos.templatemela.com/cscart/CST02/CST020042/contact-us/',
