...
<html lang="en">
<head>
<!-- <base href="<%=request.getContextPath()%>/User/"> -->
<title>Shopping Cart Software &amp; Ecommerce Software Solutions
	by CS-Cart</title>
...
<meta name="description"
	content="Secure and full-featured Online Shopping Cart Software with the complete set of powerful ecommerce options to create your own online store with minimum efforts involved." />



<meta name="keywords"
	content="shopping cart, software, ecommerce software, online store" />
						...
						<div class="span16 main-content-grid">
							<div id="breadcrumbs_10">
								...
								<div class="ty-breadcrumbs clearfix">
									<a href="index.jsp"
										class="ty-breadcrumbs__a">Home</a><span
										class="ty-breadcrumbs__slash">></span><span
										class="ty-breadcrumbs__current">Feedback</span>
								</div>
								<!--breadcrumbs_10-->
							</div>
							<div class="ty-mainbox-container clearfix">
								...
								<div class="ty-mainbox-body">
									<div class="ty-wysiwyg-content">
										...
										<div class="ty-form-builder__description">You can enter
											your Feedback here.</div>

										<div class="ty-form-builder">
											<form class="form-horizontal form-validate-jquery"
												method="post"
												action="<%=request.getContextPath()%>/feedbackController">
												<input type="hidden" name="flag" value="insert" >


												<div class="ty-control-group">
													<label for="elm_2"
														class="ty-control-group__title cm-required cm-email ">Title</label>


													 <input  class="ty-input-text cm-focus " size="50"
												...
												<div class="form-group">
													<label class="control-label col-lg-3">Feedback
										...
										<div class="ty-control-group">
											<label for="elm_3"
												class="ty-control-group__title cm-required ">Description</label>

											<textarea id="elm_3" class="ty-form-builder__textarea"
												name="description" cols="67" rows="10"></textarea>
										...
										<div class="ty-form-builder__buttons buttons-container">
											...
											<button class="ty-btn__secondary ty-btn" type="submit"
												name="dispatch[pages.send_form]">Submit</button>
			...
			$
					.extend(
							_,
							{
								...
								regexp : [],
								current_url : 'http://demos.templatemela.com/cscart/CST02/CST020042/login/?return_url=index.php%3Fdispatch%3Dorders.search',
