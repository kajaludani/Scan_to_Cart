...
<%--         	<div class="page-title">
            ...
            <!-- Form validation -->
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/categoryController" role="form" method="post">
            <input type="hidden" name="flag" value="insert">
                <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">Add Category</h6></div>
...
<!--                         <div class="alert alert-info fade in widget-inner">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="categoryName" id="firstname" required="required" >
                            </div>
                        </div>

                       
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Category Discription: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="categoryDiscription" class="required form-control" required="required"></textarea>
                            </div>
                        </div>
