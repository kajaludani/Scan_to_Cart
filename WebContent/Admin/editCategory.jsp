                    ...
                    <div class="panel-body">
                       ...
                       <!--  <div class="alert alert-info fade in widget-inner">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="categoryName" id="firstname" value="${i.categoryName}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="categoryDiscription" class="required form-control">${i.categoryDiscription}</textarea>
                            </div>
                        </div>
