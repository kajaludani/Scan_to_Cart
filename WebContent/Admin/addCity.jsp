                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="id" class="required form-control">
                                    <h:forEach items="${sessionScope.sList}" var="j">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="cityName" id="firstname">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">City Description: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="cityDiscription" class="required form-control"></textarea>
                            </div>
                        </div>
