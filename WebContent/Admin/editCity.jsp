...
<body>
    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <!-- Form validation -->
            <h:forEach items="${sessionScope.editList}" var="i">
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/cityController" role="form" method="post">
            <input type="hidden" name="id" value="${i.cityId}">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                       <input type="text" class="required form-control" name="countryName" id="firstname" value="${i.countryVO.countryName}">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="stateName" id="firstname" value="${i.statevo.stateName}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">City Name: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="cityName" id="firstname" value="${i.cityName}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">City Discription: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="cityDiscription" class="required form-control">${i.cityDiscription}</textarea>
                            </div>
                        </div>
