    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title">View Category</h6></div>
                <div class="datatable">
                    <table class="table">
                        <thead>
                            <tr>
                ...
                <h:forEach items="${sessionScope.List }" var="i">
                        <tbody>
                            <tr>
								...
								<td><a href="<%=request.getContextPath()%>/categoryController?flag=delete&id=${i.categoryId}">Delete</a>/
                                <a href="<%=request.getContextPath()%>/categoryController?flag=edit&id=${i.categoryId}">Edit</a></td></tr>
