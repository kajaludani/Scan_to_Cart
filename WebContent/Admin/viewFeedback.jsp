    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title">View Feedback</h6></div>
                <div class="datatable">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>${i.feedbackRatings}</td>
                                <td>${i.feedbackDescription}</td>
                                <td>${i.feedbackDate}</td>
                                <td>${i.feedbackTime}</td>
                               	<td><a href="<%=request.getContextPath()%>/feedbackController?flag=delete&id=${i.feedbackId}">Delete</a></td>
                            </tr>
