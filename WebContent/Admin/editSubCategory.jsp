...
<h:forEach items="${sessionScope.List}" var="i">
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/subcategoryController" role="form" method="post">
            <input type="hidden" name="id" value="${i.subcategoryId}">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="categoryName" id="firstname" value="${i.categoryvo.categoryName}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">SubCategory Name: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="subcategoryName" id="firstname" value="${i.subcategoryName}">
                            </div>
                        </div>

                       
                        <div class="form-group">
                            <label class="col-sm-2 control-label">SubCategory Discription: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="subcategoryDiscription" class="required form-control">${i.subcategoryDiscription}</textarea>
                            </div>
                        </div>
