    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title">View Product</h6></div>
                <div class="datatable">
                    <table class="table">
                        <thead>
                            <tr>
                ...
                <h:forEach items="${sessionScope.List}" var="i">
                        <tbody>
                            <tr>
								...
								<td><a href="<%=request.getContextPath()%>/productController?flag=delete&id=${i.productId}">Delete</a>/
                                <a href="<%=request.getContextPath()%>/productController?flag=edit&id=${i.productId}">Edit</a></td>
                            </tr>
 	                        </tbody>
                </h:forEach>
                    </table>
