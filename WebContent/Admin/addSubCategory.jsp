...
<form class="form-horizontal validate" action="<%=request.getContextPath()%>/subcategoryController" role="form" method="post">
            ...
            <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">Add SubCategory</h6></div>
                    <div class="panel-body">
						...
						<div class="form-group">
                            <label class="col-sm-2 control-label">Sub-Category Name: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="subcategoryName" required="required" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Sub-Category Description: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="subcategoryDiscription" class="required form-control" required="required"></textarea>
                            </div>
                        </div>
