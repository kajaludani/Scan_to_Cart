...
<body>
    ...
    <div class="page-container container-fluid">
        ...
        <div class="page-content">
            ...
            <!-- /statistics -->
            <!-- Form validation -->
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/stateController" role="form" method="post">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="stateName" id="firstname" value="${i.stateName}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">State Discription: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="stateDiscription" class="required form-control">${i.stateDiscription}</textarea>
                            </div>
                        </div>
