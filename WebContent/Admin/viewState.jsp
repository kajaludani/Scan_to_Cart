                       ...
                       <h:forEach items="${sessionScope.List }" var="i">
                        <tbody>
                            <tr>
                                <td>${i.stateId}</td>
                                <td>${i.stateName}</td>
                                <td>${i.stateDiscription}</td>
                                <td>${i.countryvo.countryName}</td>
                                <td><a href="<%=request.getContextPath()%>/stateController?flag=delete&id=${i.stateId}">Delete</a>/
                                <a href="<%=request.getContextPath()%>/stateController?flag=edit&id=${i.stateId}">Edit</a></td>
                            </tr>
                        </tbody>
                </h:forEach>
