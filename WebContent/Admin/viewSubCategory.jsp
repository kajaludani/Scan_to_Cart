     ...
     <!--        <ul class="row stats">
      ...
      -->       <!-- /statistics -->
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title">View Subcategory</h6></div>
                <div class="datatable">
                    <table class="table">
                        <thead>
                            <tr>
                ...
                <h:forEach items="${sessionScope.List}" var="i">
                        <tbody>
                            <tr>
								...
								<td><a href="<%=request.getContextPath()%>/subcategoryController?flag=delete&id=${i.subcategoryId}">Delete</a>/
                                <a href="<%=request.getContextPath()%>/subcategoryController?flag=edit&id=${i.subcategoryId}">Edit</a></td></tr>
