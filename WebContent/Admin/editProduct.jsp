...
<%--         	<div class="page-title">
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/productController" role="form" method="post">
 ...
 -->
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="productName" id="firstname" value="${i.productName}">
                            </div>
                        </div>
						<div class="form-group">
                            <label class="col-sm-2 control-label">Product Size: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="productSize" id="firstname" value="${i.productSize}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Product Price: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="productPrice" id="firstname" value="${i.productPrice}">
                            </div> 
                    </div>
                    <div class="form-group">
                            <label class="col-sm-2 control-label">Product Discription: <span class="mandatory">*</span></label>
                            <div class="col-sm-10">
                                <textarea rows="5" cols="5" name="productDiscription" class="required form-control">${i.productDiscription}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
							<select name="Floor" class="required form-control" name="floor">${i.floor}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
							<select name="Rack" class="required form-control" >${i.rack}
                                <option>A</option>
                               <option>B</option>
                               <option>C</option>
                               <option>D</option>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="required form-control" name="offers" id="firstname" value="${i.offers}">
                            </div>
                         </div>
	</div>
